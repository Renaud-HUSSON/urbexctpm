...
router.post('/', [multer.single('image'), passport.authenticate('jwt', { session: false }), create])
router.patch('/:id', [multer.single('image'), passport.authenticate('jwt', { session: false }), update])
